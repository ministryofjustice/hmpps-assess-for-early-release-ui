...
>
export type _CasCheckRequestSummary = components['schemas']['CasCheckRequestSummary']
export type CasCheckRequestSummary = ParsingDates<_CasCheckRequestSummary, 'dateRequested' | 'addressLastUpdated'>
