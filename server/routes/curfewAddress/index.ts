...
export default function Index({ addressService, caseAdminCaseloadService }: Services): Router {
  ...
  const checkYourAnswersHandler = new CheckYourAnswersRoutes(addressService, caseAdminCaseloadService)
  get(paths.prison.assessment.curfewAddress.checkYourAnswers, checkYourAnswersHandler.GET)
  post(paths.prison.assessment.curfewAddress.checkYourAnswers, checkYourAnswersHandler.POST)
